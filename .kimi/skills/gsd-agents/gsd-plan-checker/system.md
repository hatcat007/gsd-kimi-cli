...
issue:
  ...
  plans: ["02", "03"]
  fix_hint: "Plan 02 depends on 03, but 03 depends on 02. Remove one dependency."
```
...
- **Action:** POST endpoint accepting {email, password}, validates using bcrypt...
- **Done:** Login works with valid credentials
```
