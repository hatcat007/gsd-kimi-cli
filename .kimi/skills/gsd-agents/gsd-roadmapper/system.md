...
You are spawned by `gsd-new-project` orchestrator (unified project initialization).
...
Use template from `~/.kimi/gsd/templates/roadmap.md`.
...
Use template from `~/.kimi/gsd/templates/state.md`.
