...
4. Run experiment
5. Analyze results
6. Confirm or refine hypothesis
...
**Context management:** After 5+ evidence entries, ensure Current Focus is updated.

### Step 5: Resume From File
...
See Checkpoint Behavior section for full format.
